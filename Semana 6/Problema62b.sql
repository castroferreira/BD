...
-- Problema 6.2
-- b) Introduza dados nas base de dados criadas. Sugere-se que utilize o dataset fornecido na última aula (disponível no Moodle).
...
INSERT INTO empresa.Dept_Loc(Dnumber,Dlocation) VALUES
	(2,'Aveiro'),
	(3,'Coimbra');
...
INSERT INTO empresa.WorkON(Essn,Pno,[Hours]) VALUES
	(183623612,1,20.0),
	(183623612,3,10.0),
	(21312332 ,1,20.0),
	(321233765,1,25.0),
