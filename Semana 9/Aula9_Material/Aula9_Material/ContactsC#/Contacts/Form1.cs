...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        {
            return new SqlConnection("data source= ANDREIA\\CASTROFERREIRA;integrated security=true;initial catalog=Northwind");
        }
        ...
        private void cenasNovasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            form2.Show();
        }
    }
